 ...
 */
export declare function replaceInFile(file: string, changes?: Array<ReplaceChanges>): (tree: import("@angular-devkit/schematics/src/tree/interface").Tree) => import("@angular-devkit/schematics/src/tree/interface").Tree;
