...
export declare function addModuleImportToRootModule(options: any, moduleName: string, modulePath: string): (host: import("@angular-devkit/schematics/src/tree/interface").Tree) => import("@angular-devkit/schematics/src/tree/interface").Tree;
