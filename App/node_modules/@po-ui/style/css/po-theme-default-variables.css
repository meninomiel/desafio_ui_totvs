...
:root {
  ...
  */
  ...
  --color-button-color-primary: var(--color-neutral-light-98);

  --color-button-background-color-primary-hover: var(--color-primary-light-80);
  --color-button-border-primary-hover: var(--color-primary-light-80);
  --color-button-color-primary-hover: var(--color-neutral-light-98);

  --color-button-background-color-primary-pressed: var(--color-primary);
  --color-button-border-primary-pressed: var(--color-primary);
  --color-button-color-primary-pressed: var(--color-neutral-light-98);
  ...
  */
  ...
  --color-calendar-background-color-box-background-active: var(--color-primary);
  ...
  --color-calendar-background-color-box-background-selected: var(--color-primary);
  --color-calendar-background-color-box-background-today: var(--color-neutral-light-80);
  --color-calendar-background-color-box-background-today-hover: var(--color-neutral-light-60);

  --color-calendar-color-box-foreground: var(--color-neutral);
  --color-calendar-color-box-foreground-selected: var(--color-neutral-light-80);
